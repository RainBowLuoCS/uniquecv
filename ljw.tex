...
\section{教育背景}
\dateditem{\textbf{华中科技大学} \quad 软件工程 \quad 本科}{2020年 --  2024\quad}
...
\section{专业技能}
\smallskip
C/C++、Python、Java、算法与数据结构、Linux、Pytorch 、JS
...
% ---
\datedproject{拼多多前端开发实习生}{实习项目}{2023年06月 -- 2023年09月}
\textit{JS,算法}
\vspace{0.4ex}
...
% \end{itemize}
% ---
\datedproject{Nerf项目}{科研项目}{2022年12月 -- 2023年04月}
\textit{pytorch、nerf}
\vspace{0.4ex}
...
\dateditem{\textbf{华中科技大学计算机学院智能媒体计算与网络安全实验室}}{2022年12月 -- 至今}
