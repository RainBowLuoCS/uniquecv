...
% ---
\datedproject{超算ASC2022项目}{竞赛项目}{2022年01月 -- 2022年05月}
...
\begin{itemize}
  ...
  \item 单机优化性能达2x, 多机接近线性加速比，4.7B大语言模型一小时收敛
\end{itemize}

% ---
\datedproject{脑桥横截面病灶诊断项目}{导师项目}{2021年04月 -- 持续}
\textit{pytorch,语义分割}
\vspace{0.4ex}

使用Unet++做病灶的标注和训练检测？

\datedproject{多目标追踪项目}{}{2021年09月 -- 持续}
...
使用nlp通用模型 bret+fcn 采用Q&A阅读理解语言模型改进，设计并训练，封测取得Rank9的成绩
% ----------------------------------------------------------------------------- %

\section{课外}
\dateditem{\textbf{华中科技大学联创团队}}{2021年04月 -- 至今}
