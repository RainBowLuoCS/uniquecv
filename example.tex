...
提出了不使用MAM模块的普通VIT注意力结构的新更踪器,在MAE decoder的训练下表现SOTA，即插即用的decoder可以很好的提高单目标跟踪器的效果，accpeted by AAAI2023(oral)\textbf{Song, Zikai and Luo, Run and Yu, Junqing and Chen, Yi-Ping Phoebe and Yang, Wei,Compact Transformer Tracker with Correlative Masked Modeling,Proceedings of the AAAI Conference on Artificial Intelligence (AAAI),February,2023}
% ---
