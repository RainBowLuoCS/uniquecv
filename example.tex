...
\textit{pytorch、单目标跟踪，\textbf{AAAI2023}}
\vspace{0.4ex}

在MixFormer基础上提出了不使用MAM模块的普通VIT注意力结构的新更踪器,在MAE decoder的训练下表现SOTA，即插即用的decoder可以很好的提高单目标跟踪器的效果，accpeted by AAAI2023 \textbf{在TrackingNet,LaSOT,UAV,GOT10k数据集上都超过了 CVPR2022 oral Mixformer}
% ---
