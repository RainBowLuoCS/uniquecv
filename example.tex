...
\section{专业技能}
\smallskip
C/C++、Python、Java、算法与数据结构、Linux、Ray、Pytorch、Tensorflow、集群并行训练,ColossalAI
...
\textit{pytorch、单目标跟踪，\textbf{MM2022-->AAAI2023}}
\vspace{0.4ex}
...
% ---
\datedproject{HyaDIS弹性调度}{实习项目}{2022年07月 -- present}
